...
class MapDisplay extends Component {
   state = {
    ...
    getBusinessInfo = (props, data) => {
        // Look for matching theatre data in FourSquare compared to what we already
        // know
        return data
            .response
            .venues
    ...
    onMarkerClick = (props, marker, e) => {
        ...
        // Fetch the FourSquare data for the selected theatre
        ...
        fetch(request)
            ...
            .then(result => {
                // Get just the business reference for the theatre we want from the FourSquare
                // return
                ...
                // Get the list of images for the theatre if we got FourSquare data, or just
